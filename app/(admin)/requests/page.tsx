            ...
            <div className={styles.detailContent}>
              <div className={styles.detailToolbar}>
                ...
                <div className={styles.toolGroup}>
                  ...
                  <button className={`${styles.secondaryBtn} ${styles.deleteBtn}`} onClick={handleDelete}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="overlay" onClick={e => e.target === e.currentTarget && setShowDeleteModal(false)}>
          <div className="modal" style={{ maxWidth: 440 }}>
            <div style={{ padding: '28px 28px 24px' }}>
              {/* Icon */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 52, height: 52, borderRadius: '50%', background: '#fef2f2', margin: '0 auto 20px' }}>
              ...
              {/* Title */}
              <h2 style={{ textAlign: 'center', fontSize: '18px', fontWeight: 700, color: '#0f172a', marginBottom: 8 }}>Delete Request</h2>
              {/* Description */}
              <p style={{ textAlign: 'center', fontSize: '14px', color: '#64748b', lineHeight: 1.6, marginBottom: 28 }}>
                Are you sure you want to delete <strong style={{ color: '#0f172a' }}>&ldquo;{selectedRequest?.title}&rdquo;</strong>?<br />
